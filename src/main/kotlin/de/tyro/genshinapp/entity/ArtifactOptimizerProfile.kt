...
@Entity
@Table(
    name = "artifact_optimizer_profiles",
    uniqueConstraints = [
        UniqueConstraint(
            name = "uk_artifact_optimizer_profiles_user_character",
            columnNames = ["user_id", "character_key"],
        ),
    ],
)
open class ArtifactOptimizerProfile {
    @Id
    ...
    open var customProfileId: Long? = null
